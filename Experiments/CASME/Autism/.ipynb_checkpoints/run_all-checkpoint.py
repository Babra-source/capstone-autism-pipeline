...
======================================
Thesis: Evaluating the Effectiveness of Facial Expression Recognition and
        Eye-Tracking Techniques in Detecting Emotional Cues of Minimal Verbal
        Autistic Students.

Research Questions
------------------
RQ1: How effective is the integration of FER and eye-tracking in detecting
     autism emotional cues?
     -> Experiments 3 (Early Fusion) and 4 (Late Fusion) vs. single-stream
        baselines. Answered by: compare_experiments() and fusion lift chart.

RQ2: How can eye-tracking data improve emotion recognition accuracy compared
     to FER alone?
     -> Eye models (ResNet18Eye, ResNet50Eye, ViTEye) evaluated head-to-head
        against same-backbone FER models. Answered by: rq2_eye_vs_face.py.

RQ3: What is the correlation between gaze patterns and emotional states?
     -> Pearson/Spearman correlations, t-SNE, radar charts of gaze feature
        profiles per emotion class. Answered by: rq3_gaze_correlation.py.
...
-----
    ...
    # Quick smoke test (2 epochs, skip RQ3):
    python run_all.py --data_dir ... --label_file ... \\
        --epochs 2 --skip_rq3

    # Skip specific experiment groups:
    python run_all.py ... --skip_exp1 --skip_exp2_extra
"""
...
# ─────────────────────────────────────────────────────────────────────────────
# Hardcoded paths (modify these to your local CASME2 dataset paths)
# ─────────────────────────────────────────────────────────────────────────────
